...
require_once __DIR__ . '/cli/RouteCache.php';
require_once __DIR__ . '/cli/Config.php';
require_once __DIR__ . '/cli/Optimize.php';
require_once __DIR__ . '/cli/Sitemap.php';
require_once __DIR__ . '/cli/KeyGen.php';
...
try {
    switch ($command) {
        ...
        case 'queue:work':
            require_once __DIR__ . '/cli/QueueWork.php';
...
\033[33mAvailable Commands:\033[0m
  ...
  \033[32mschedule:run\033[0m        Execute scheduled tasks from /app/tasks/my-task.php 
  ...
  \033[32mconfig:clear\033[0m        Clear all application caches (app/cache/)
  \033[32mapp:optimize\033[0m        Unified production optimization (config + models + assets)
  \033[32mapp:init\033[0m            Initialize application (deprecated - structure is ready)
