...
class Optimize extends Command
{
    ...
    private function clearCache(): void
    {
        ...
        $this->info("✓ Cleared: app/cache/ directory");
    }
    ...
    {
        $appDir = rtrim(CoreConfig::$DIR_PROJECT, '/') . '/app';
    ...
    private function runHealthCheck(): void
    {
        ...
        $dirs = [
            CoreConfig::$DIR_PROJECT . '/app',
            CoreConfig::$DIR_PROJECT . '/app/logs',
            CoreConfig::$DIR_PROJECT . '/app/cache',
            CoreConfig::$DIR_PROJECT . '/assets'
        ];
