...
class Seed extends Command
{
    ...
    {
        parent::__construct();
        $this->seedersDir = dirname(__DIR__) . '/cli/seeders';
    ...
    public function run(array $args): void
    {
        ...
        if (empty($seeders)) {
            ...
            $this->info("Create a seeder with: php cli.php seed:create SeederName");
            return;
        }
    ...
    public function create(array $args): void
    {
        if (empty($args[0])) {
            ...
            $this->info("Usage: php cli.php seed:create UserSeeder");
            return;
        }
