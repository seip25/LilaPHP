...
class Debug
{
    ...
    /** @var bool Has the debug end logic already been executed */
    ...
    public static function init(): void
    {
        ...
        try {
            $path = Config::$DIR_PROJECT . "/app/cache";
            if (!is_dir($path)) {
    ...
    public static function getRequests(int $limit = 100): array
    {
        ...
        try {
            $stmt = self::$db->prepare("SELECT * FROM debug_requests ORDER BY id DESC LIMIT " . (int)$limit);
            $stmt->execute();
